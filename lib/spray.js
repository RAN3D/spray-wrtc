...
class Spray extends N2N {
    ...
    /**
     * @private Called each time this protocol receives a message. Since it only
     * sends MExchange messages, the rest are redirected to the appropriate
     * protocol registered on top of Spray.
